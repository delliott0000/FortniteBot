lookup = {
  ...
  "Daily Rewards": {
    ...
    "11": {
      "templateId": "ConditionalResource:currency_mtxswap",
      "quantity": 50
    },
    "12": {
  ...
  "Items": {
    ...
    "ConditionalResource:currency_mtxswap": {
      "name": {
        "PassedConditionItem": "V-bucks",
        "FailedConditionItem": "X-Ray Tickets"
      },
      "rarity": "legendary",
      "note": "the real rarity of this item is epic, but to simplify the code I just grab the V-Bucks rarity from here",
  ...
  "Survivor Squads FORT": {
    "EMT Squad": "Fortitude",
    "Training Team": "Fortitude",
    "Fire Team Alpha": "Offense",
    "Close Assault Squad": "Offense",
    "Gadgeteers": "Resistance",
    "Scouting Party": "Resistance",
    "Corps Of Engineering": "Tech",
    "The Think Tank": "Tech"
  },
  "Leads Preferred Squad": {
    "Homebase.Manager.IsDoctor": "EMT Squad",
    "Homebase.Manager.IsTrainer": "Training Team",
    "Homebase.Manager.IsSoldier": "Fire Team Alpha",
    "Homebase.Manager.IsMartialArtist": "Close Assault Squad",
    "Homebase.Manager.IsGadgeteer": "Gadgeteers",
    "Homebase.Manager.IsExplorer": "Scouting Party",
    "Homebase.Manager.IsEngineer": "Corps Of Engineering",
    "Homebase.Manager.IsInventor": "The Think Tank"
  },
  "Lead Bonus Increment": {
    "uncommon": (2, 0),
    "rare": (3, 0),
    "epic": (4, 0),
    "legendary": (5, 0),
